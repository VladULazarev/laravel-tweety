...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/more-tweets', [TweetController::class, 'moreTweets'])->name('more-tweets');
    ...
    // User's Profile
    Route::get('/profiles/{user:username}', [UserProfileController::class, 'show'])->name('user-profile');
    Route::post('/more-profiles-tweets/{user:username}', [UserProfileController::class, 'showMoreProfileTweets'])
        ->name('more-profile-tweets');
